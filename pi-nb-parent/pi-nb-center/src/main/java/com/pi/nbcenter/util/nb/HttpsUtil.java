...
//		String demo_base_Path = HttpsUtil.class.getResource("/").getPath();
//		String selfcertpath = demo_base_Path + Constant.SELFCERTPATH;
//		String trustcapath = demo_base_Path + Constant.TRUSTCAPATH;

		KeyStore selfCert = KeyStore.getInstance("pkcs12");
		selfCert.load(HttpsUtil.class.getResourceAsStream(Constant.SELFCERTPATH),
		...
		caCert.load(HttpsUtil.class.getResourceAsStream(Constant.TRUSTCAPATH), Constant.TRUSTCAPWD.toCharArray());
