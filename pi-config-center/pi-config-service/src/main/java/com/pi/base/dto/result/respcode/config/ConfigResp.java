...
public enum ConfigResp {
  ...
  RESP_CONFIG_APP_ID_NOT_FOUND(2100104, "CONFIG_PARTNER.APP_ID_NOT_FOUND", "appId不存在"),
  RESP_CONFIG_APP_SECRET_NOT_FOUND(2100105, "CONFIG_PARTNER.APP_SECRET_NOT_FOUND", "appSecret不存在")
  ;
